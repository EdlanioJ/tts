...
func (c *textToSpeechClient) Say(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/github.com.EdlanioJ.tts.TextToSpeech/Say", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTextToSpeechServer) Say(context.Context, *Request) (*Response, error) {
...
func _TextToSpeech_Say_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.EdlanioJ.tts.TextToSpeech/Say",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TextToSpeechServer).Say(ctx, req.(*Request))
	}
...
var TextToSpeech_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.EdlanioJ.tts.TextToSpeech",
